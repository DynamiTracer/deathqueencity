...
class SoftView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        sql +=  'WHEN "PC88・98・FM-7・X1・MSX" THEN "ソフト" '
        sql +=  'WHEN "ファミリーコンピュータ" THEN "ソフト" '        
        sql +=  'WHEN "ディスクシステム" THEN "ソフト" '
        sql +=  'WHEN "ゲームボーイ" THEN "ソフト" '
        sql +=  'WHEN "スーパーファミコン" THEN "ソフト" '        
        sql +=  'WHEN "サテラビュー" THEN "ソフト" '
        ...
        sql +=  'WHEN "テレホンカード 1999-2002" THEN "テレホンカード" '
        sql +=  'WHEN "クロノトリガー プリズムカード" THEN "プリズムカード" '
        sql +=  'WHEN "ファミリーコンピュータカートンダンボール" THEN "カートンダンボール" '
        sql +=  'WHEN "ディスクシステムカートンダンボール" THEN "カートンダンボール" '
        sql +=  'WHEN "ゲームボーイダンボール" THEN "カートンダンボール" '
        sql +=  'WHEN "スーパーファミコンダンボール" THEN "カートンダンボール" '        
        sql +=  'WHEN "PC88・98・FM-7・X1・MSX" THEN "ソフト" '
        sql +=  'WHEN "ファミリーコンピュータ" THEN "ソフト" '        
        sql +=  'WHEN "ディスクシステム" THEN "ソフト" '
        sql +=  'WHEN "ゲームボーイ" THEN "ソフト" '
...
class CategoryView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        sql +=  'WHEN "ファミリーコンピュータカートンダンボール" THEN "カートンダンボール" '
        sql +=  'WHEN "ディスクシステムカートンダンボール" THEN "カートンダンボール" '
        sql +=  'WHEN "ゲームボーイカートンダンボール" THEN "カートンダンボール" '
        sql +=  'WHEN "スーパーファミコンカートンダンボール" THEN "カートンダンボール" '        
